...
?>
    ...
    <?php
            ...
            $ses =  $_SESSION['username'];
                  $sql = "select email_conduc, origen_direccion, origen_localidad, destino_direccion, destino_localidad, distancia_estimada, tiempo_estimado
 from VIAJE where email_cli like '$ses' && estado like 'FINALIZADO'";
...
<div class="table table-hover table-responsive" style="margin-top: 100px;">
  <h2 style="text-align: center;">Viajes con UBER</h2>
