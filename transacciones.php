...
<div class="table table-hover table-responsive">
 ...
 <table class="table table-hover">
    ...
    <tbody>
     <?php 
      $conexion= ConectarBD();
      $sql = "select cuota_conductor, gstos_gestion, fecha, email_conduc, email_cli, estado_pago
                            from transacciones
                            where table_schema='gi_uber'
                            group by email_conduc, email_cli, fecha, cuota_conductor, gastos_gestion, estado_pago;";
